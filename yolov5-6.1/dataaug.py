...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default='DIYDATASET/VOC2007/VOCdevkit/JPEGImages')
    parser.add_argument('--source_xml_path', type=str, default='DIYDATASET/VOC2007/VOCdevkit/Annotations')
    parser.add_argument('--save_img_path', type=str, default='DIYDATASET/VOC2007/VOCdevkit/AugpotoJPEGimages/JPEGImages')
    parser.add_argument('--save_xml_path', type=str, default='DIYDATASET/VOC2007/VOCdevkit/AugpotoAnnoto/Augxml')
