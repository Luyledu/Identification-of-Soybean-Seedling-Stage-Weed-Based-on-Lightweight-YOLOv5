...
image_set = 'Augxml'  # 需要转换的文件夹名称（文件夹内放xml标签文件）
imageset2 = 'AugMSCOCO_txt'  # 保存txt的文件夹
# 2.
# 换成你的类别 当前的顺序，就txt 0,1,2,3 四个类别
classes = ['soybean','machixian','matang','tiexiancai','ciercai','li','dawanhua']  # 标注时的标签 注意顺序一定不要错。

# 3.
# # 转换文件夹的绝对路径
data_dir = 'D:\Aaysydataset\YOLOv5my\yolov5-6.1\DIYDATASET\VOC2007\VOCdevkit\AugpotoAnnoto'
'''
